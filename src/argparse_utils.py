...
def parse_args():
    ...
    parser.add_argument("--phase", type=str, default="train_step1", help="Phase of the training process (train_step1/train_step2/train_step3/test)")
    ...
    parser.add_argument("--model_name", type=str, default="HOCM-Net.model", help="Name of the model")
    parser.add_argument("--save_intval", type=int, default=2000, help="Interval for saving checkpoints")
    parser.add_argument("--testdata_dir", type=str, default="../../../HOCM24/test/image", help="Directory for test data")
    parser.add_argument("--labeling_dir", type=str, default="../result-test", help="Directory for labeling data")
    parser.add_argument("--testlabel_dir", type=str, default="../../../HOCM24/test/label", help="Directory for test labels")
    parser.add_argument("--predlabel_dir", type=str, default="../../../HOCM24/train/pred_label", help="Directory for pred labels")
